        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
            <div className='flex flex-col gap-5'>
                ...
                h-64 flex justify-center items-center'>
                    ...
                    {generatingImg && (
                        <div className='absoluite inset-0 z-0 flex
                        justify-center items-center bg-[rgba(0,0,0,0,0.5)]
                        rounded-lg'>
                            <Loader />
                        </div>
                    )}
            ...
            <div className='mt-10'>
                <p className='mt-2 text-[#666e75] text-[14px]'>One you have created the image you want, you can 
